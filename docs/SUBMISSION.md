...
**C. Category breakdown:** See `results.md` and the [allocation CSV](https://mosaic-mix-lab-devadharshini.ochre-deer-1487.chatgpt.site/results/allocation.csv). For the linear maximum: Email allocation ₹1,500,000.00 → revenue ₹13,932,027.40; SMS ₹1,200,000.00 → ₹7,298,630.14; Affiliate ₹2,300,000.00 → ₹12,622,904.11. Other seven channels receive zero. Add −₹0.01 rounding adjustment to reconcile the displayed revenues exactly. The proportional breakdown covers all ten channels and needs no adjustment.
...
**G. Write-up:** `docs/write-up.md`, **375 words**.

**H. Form description:** `docs/form-description.txt`, **391 characters**, excluding its trailing newline.

**I. Tech stack:** React, TypeScript, Vite, CSS, Lucide, decimal.js, Python Decimal/Fraction/unittest, ESLint, Prettier, OpenAI Sites, FFmpeg, Microsoft neural speech synthesis.

**J. Validation:** Complete official data; 16 unit tests; independent Node.js reconciliation; TypeScript; lint; production build; budget/cap and rounding reconciliation; desktop/mobile browser QA; public HTTP/payload checks; video duration, encoding, audio, captions, and representative frames.
